...
public class GameView {
    ...
    private void buildFrame() {
        // Construcci+�n de UI en EDT para evitar violaciones de thread-safety de Swing.
    ...
    public void showPlayerHand(ArrayList<Card> hand) {
        // Arranca animaci+�n as+�ncrona y devuelve control al hilo de juego.
    ...
    public void showCommunityCards(
        ...
        // Mantiene la animaci+�n alineada con el n+�mero de cartas nuevas.
        CompletableFuture<Boolean> completion = new CompletableFuture<>();
        animationFuture = completion;
    ...
    /** Indica que el jugador se retir+� */
    ...
    /**
     * Bloquea el hilo del juego hasta que el jugador elige una acci+�n.
     * Muestra los botones correspondientes seg+�n el estado de la ronda.
     */
    ...
    public void resolvePendingPlayerAction(BettingRound.Action action) {
        // Resuelve manualmente una acci+�n pendiente cuando hubo timeout.
    ...
    public boolean askResumeGame(int savedChips) {
        return callOnEdtAndWait(() -> {
            int opt = JOptionPane.showConfirmDialog(
                frame,
                "Ten+�s una partida guardada con " +
    ...
    private void scheduleAnimationCompletion(
        ...
        // Timer dedicado por animaci+�n: evita bloquear el EDT.
        animationFuture = completion;
    ...
    public boolean awaitLastAnimation(long timeoutMs) {
        // Permite al hilo de juego esperar la +�ltima animaci+�n sin bloquear el EDT.
    ...
    class TablePanel extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            // Mazo solo en men+� Y sin imagen
            if (!isGameActive && bg == null) drawDeckPile(g2); // solo mazo si NO hay imagen
            if (isGameActive) {
                // Solo dibujar elementos de juego cuando est+� activo
                drawLabels(g2, W, H);
        ...
        private void drawRoleBadges(Graphics2D g2, int W, int H) {
            ...
            String humanBadge = playerName.isEmpty() ? "T+�" : playerName;
    ...
    static class CardSprite {
        ...
        private void drawFace(Graphics2D g2) {
            ...
            boolean red = suit.equals("���") || suit.equals("�֪");
    ...
    static class CasinoDialog extends JDialog {
        ...
        CasinoDialog(
            ...
            setContentPane(root);
            pack();
            // MODIFICAR TAMA+�O TOTAL DEL DIALOGO: Cambiar setSize(ancho, alto)
            setSize(380, 310);
        ...
        private void confirm() {
            ...
            if (text.isEmpty() || text.matches(".*[\\d\\W].*")) {
                ...
                field.setText("");
                field.setToolTipText("Solo letras, sin n+�meros ni s+�mbolos");
                return;
            }
            result = text;
            dispose();
